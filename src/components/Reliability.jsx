const cards = [
  {
    ...
    text: 'Покрытие до 3 000 м². Пробиваем цокольные этажи, бетонные перегородки и помещения с толстыми стенами — без дополнительных ретрансляторов. Больше никаких «у нас кнопка не сработала».',
    icon: (
    ...
    <section className="bg-emerald-deep py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <p className="mt-5 max-w-2xl text-lg text-text-secondary leading-relaxed">
          ...
          многозальных ресторанов с ВИП-комнатами за бетонными стенами. Ни&nbsp;один вызов
          не&nbsp;потеряется.
        </p>
