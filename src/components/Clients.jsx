  ...
  return (
    <div className="flex-shrink-0 mx-4 flex items-center justify-center w-28 h-20 sm:w-36 sm:h-24 rounded-xl border border-border-neutral bg-white/5 p-3 hover:bg-white/10 transition-colors">
      <img
        src={logo.src}
        alt={logo.alt}
        className="max-w-full max-h-full object-contain filter brightness-90 hover:brightness-100 transition-all"
        loading="lazy"
      />
    </div>
  )
...
export default function Clients() {
  ...
  return (
    <section className="bg-emerald-dark py-20 sm:py-28 overflow-hidden">
